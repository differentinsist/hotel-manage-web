<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>本店评论</el-breadcrumb-item>
    </el-breadcrumb>
...
<script>
  ...
  export default {
    ...
    created(){
      //在页面初始化之后都更新一下路径的状态值；好实现高亮菜单  ---------我的---------------------
      this.$store.commit('changeActivePath'); //----------------我的-----------------------
    }
  }
</script>
...
<!--是否可以同时使用多种样式语法 有less、stylus、等-->
<!--<style lang="less" scoped>加less语法的话好像导致el-row布局不生效  -->
